...
//Pasamos los datos
const Cartas = ({loadingData, showData, weather, forecast}) => {
    
    var today = new Date();
    var day = today.getDate(); //dia
    var month = today.getMonth() + 1; //mes
    var year = today.getFullYear(); //año
    var date = day + '/' + month + '/' + year; //dia+mes
    ...
    if(showData){
        ...
        iconUrl=url+weather.weather[0].icon+".png";//visualizar los iconos

        iconUrl3 = url + forecast.list[1].weather[0].icon + ".png"; //viasualizar los iconos de prediccion
        iconUrl6 = url + forecast.list[2].weather[0].icon + ".png";
        iconUrl9 = url + forecast.list[3].weather[0].icon + ".png";
                                            //accede la fecha en la op 1, hora y fecha, separa, siguiente mes, 
        ...
        <div className="mt-5">
            {
                showData == true?(
                    <div className="container">
                        <div className="card mb-3 mx-auto bg-dark text-light">
                            <div className="row g-0">
                                ...
                                <img src="https://images.pexels.com/photos/1738991/pexels-photo-1738991.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" className="img-fluid rounded-start" alt=".."/>
                                </div>
                    ...
                    <h2 className="text-light">Ingresa una Ciudad</h2>
                )
            }
        </div>
    );
